    ...
    def build_hybrid_retriever(self, docs):
        ...
        try:
            ...
            vector_store = Chroma.from_documents(
                ...
                persist_directory=settings.CHROMA.CHROMA_DB_PATH
            )
            ...
            vector_retriever = vector_store.as_retriever(search_kwargs={"k": settings.RETRIEVAL.VECTOR_SEARCH_K})
            logger.info("Vector retriever created successfully.")
            
            # Combine retrievers into a hybrid retriever
            hybrid_retriever = EnsembleRetriever(
                retrievers=[bm25, vector_retriever],
                weights=settings.RETRIEVAL.HYBRID_RETRIEVER_WEIGHTS
            )
